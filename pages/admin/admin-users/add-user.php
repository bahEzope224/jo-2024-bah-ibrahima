...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $password_input = filter_input(INPUT_POST, 'password', FILTER_SANITIZE_STRING); // Mot de passe non hashé

    // Vérifiez si les champs obligatoires sont vides
    if (empty($nomUtilisateur) || empty($prenomUtilisateur) || empty($login) || empty($password_input)) {
        $_SESSION['error'] = "Tous les champs doivent être remplis.";
        header("Location: add-user.php");
        exit();
    }

    // Vérifiez la longueur du mot de passe non hashé
    ...
    $password = password_hash($password_input, PASSWORD_BCRYPT); // Hashage du mot de passe filtré
    ...
    <main>
        ...
        <form action="add-user.php" method="post"
            ...
            <input type="submit" value="Ajouter l'Utilisateur">
                    <p>*le mot de passe doit comporter au minimum 10 caractères</p>
