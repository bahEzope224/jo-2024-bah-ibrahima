...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nom_utilisateur) || empty($prenom_utilisateur) || empty($login) || empty($password_input)) {
    ...
    try {
        ...
        $statement->bindParam(":password", $password_hashed, PDO::PARAM_STR); // Utilisez le mot de passe hashé
