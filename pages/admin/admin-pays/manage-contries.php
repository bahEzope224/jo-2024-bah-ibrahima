    ...
    <header>
        <nav>
            ...
            <li><a href="../admin.php">Accueil Administration</a></li>
                ...
                <li><a href="manage-contries.php">Gestion Pays</a></li>
...
// (fonctionne à condition d’avoir activé l’option en local)
    ...
    <script>
        ...
        function openModifyContrieForm(id_pays) {
            ...
            // alert(id_pays);
            window.location.href = 'modify-contrie.php?id_pays=' + id_pays;
        }
        ...
        function deleteContrieConfirmation(id_pays) {
            ...
            if (confirm("Êtes-vous sûr de vouloir supprimer ce Pays?")) {
                ...
                // alert(id_pays);
                window.location.href = 'delete-contrie.php?id_pays=' + id_pays;
            }
        }
    </script>
</body>
