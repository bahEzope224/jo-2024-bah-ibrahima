...
// (fonctionne à condition d’avoir activé l’option en local)
    ...
    <script>
        ...
        function openModifyGenderForm(id_sport) {
            // Ajoutez ici le code pour afficher un formulaire stylisé pour modifier un Genre
            // alert(id_sport);
            window.location.href = 'modify-gender.php?id_genre=' + id_sport;
        }

        function deleteGenderConfirmation(id_sport) {
            ...
            if (confirm("Êtes-vous sûr de vouloir supprimer ce genre?")) {
                ...
                // alert(id_sport);
                window.location.href = 'delete-gender.php?id_genre=' + id_sport;
            }
        }
    </script>
</body>
